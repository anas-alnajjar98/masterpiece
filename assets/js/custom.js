...
$(document).on('change', ".changeTheme", function () {
    ...
    if (userColor == 'dark') {
        document.getElementById('headerLogo').src = 'assets/images/logo-white.png';
...
$(document).ready(function () {
    ...
    $(document).ready(function () {
        ...
        if (localStorage.storedValue == 'dark') {
            ...
            document.getElementById('headerLogo').src = 'assets/images/logo.svg';
            document.getElementById('footerLogo').src = 'assets/images/logo-white.png';
        }
    });
});
...
var countDownDate = new Date("November 31, 2024 12:22:25").getTime();
